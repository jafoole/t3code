...
function ConfiguredSettingsRouteScreen() {
  ...
  const promptSignIn = useCallback(() => {
    Alert.alert(
      "Request Pallet Cloud access",
      "Live Activity updates require approved Pallet Cloud access so relay can deliver updates to this device.",
      [
        { text: "Cancel", style: "cancel" },
  ...
  const handleDeviceNotificationsChange = useCallback(
    (enabled: boolean) => {
      ...
      Alert.alert(
        ...
        "Notification permission is controlled by iOS. Open Settings to disable notifications for Pallet.",
        [
          { text: "Cancel", style: "cancel" },
          { text: "Open Settings", onPress: () => void Linking.openSettings() },
        ],
      ...
      >
        <View className="gap-3">
          ...
          <Text className="px-2 text-sm leading-[18px] text-foreground-muted">
            Pallet works locally without signing in. Cloud features are optional.
          </Text>
        </View>
