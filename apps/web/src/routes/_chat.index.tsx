          ...
          <div className="w-full max-w-xl rounded-3xl border border-border/55 bg-card/20 px-8 py-12 shadow-sm/5">
            <EmptyHeader className="max-w-none">
              ...
              <EmptyDescription className="mt-2 text-sm leading-relaxed text-muted-foreground/78">
                {cloudEnabled
                  ? "Sign in to Pallet Connect to connect a linked environment through its managed tunnel, or add a reachable backend manually."
                  : "Open a pairing link from your Pallet desktop app or add a reachable backend manually. Your saved environments stay in this browser."}
              </EmptyDescription>
